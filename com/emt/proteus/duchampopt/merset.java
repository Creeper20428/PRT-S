...
/*     */ 
/*     */ public final class merset extends com.emt.proteus.runtime.api.ImplementedFunction
/*     */ {
/*     */   public static final int FNID = 2824;
/*  12 */   public static final Function _instance = new merset();
/*  13 */   public final Function resolve() { return _instance; }
/*     */   
/*  15 */   public merset() { super("merset", 1, false); }
/*     */   
...
/*     */       label76:
/*     */       
/*  70 */       MainMemory.setI32(paramInt, 204);
/*  71 */       MainMemory.setI32(paramInt + 4, 5391693);
/*  72 */       com.emt.proteus.runtime.api.SystemLibrary.memcpy(paramInt + 276, 49344, 11, 1);
/*  73 */       MainMemory.setI32(paramInt + 316, 2);
/*  74 */       MainMemory.setI32(paramInt + 320, 0);
/*  75 */       MainMemory.setI32(paramInt + 324, 0);
/*  76 */       MainMemory.setI32(paramInt + 328, 0);
/*  77 */       MainMemory.setI32(paramInt + 332, 1);
/*  78 */       MainMemory.setI32(paramInt + 336, 0);
/*  79 */       MainMemory.setI32(paramInt + 340, 1);
/*  80 */       n = paramInt + 8;
...
/*     */       
/*     */ 
/* 109 */       MainMemory.setI32(paramInt + 448, 2825);
/* 110 */       MainMemory.setI32(paramInt + 452, 2826);
/* 111 */       n = paramInt + 344;
...
/*     */       label425:
/*     */       
/* 146 */       if (mers2x.call(paramInt, 1, 1, 1, 1, i2, i3, k, m, j) != 0) {
/*     */         break label488;
/*     */       }
/*     */       
/*     */ 
...
/* Location:              /home/jkim13/Desktop/emediatrack/codejar_s.jar!/com/emt/proteus/duchampopt/merset.class
