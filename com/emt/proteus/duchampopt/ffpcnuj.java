...
/*     */ 
/*     */ 
/*     */ public final class ffpcnuj
/*     */   extends ImplementedFunction
/*     */ {
/*     */   public static final int FNID = 3571;
/*  15 */   public static final Function _instance = new ffpcnuj();
/*  16 */   public final Function resolve() { return _instance; }
/*     */   
/*  18 */   public ffpcnuj() { super("ffpcnuj", 8, false); }
/*     */   
...
/*     */     {
/*  76 */       i2 = paramInt3;
/*  77 */       if (MainMemory.getI32(paramInt5) <= 0)
/*     */       {
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 110 */         if (ffrdef.call(paramInt1, paramInt5) > 0) {
/*     */           break label820;
/*     */         } else {
/*     */           break label174;
/*     */         }
...
/*     */         label157:
/*     */         
/* 119 */         ffmahd.call(paramInt1, n + 1, 0, paramInt5);
/*     */         
/*     */ 
/*     */         label174:
/*     */         
...
/*     */ 
/*     */ 
/* 163 */         if (ffpcluj.call(paramInt1, paramInt2, paramLong1, paramLong2, paramLong3, paramInt3, paramInt5) <= 0) {
/*     */           break label366;
/*     */         }
/*     */         
/*     */ 
...
/*     */ 
/*     */ 
/* 173 */         if (MainMemory.getI32(paramInt5) != 412) {
/*     */           break label820;
/*     */         }
/*     */         
/*     */ 
...
/*     */ 
/*     */ 
/* 183 */         MainMemory.setI32(paramInt5, 0);
/*     */         
/*     */ 
/*     */         label366:
/*     */         
...
/*     */ 
/*     */ 
/* 215 */           if (MainMemory.getI32((int)(paramLong2 + (l4 << 2))) != paramInt4) {
/*     */             break label625;
/*     */           }
/*     */           
/*     */ 
...
/*     */ 
/*     */             }
/* 252 */             else if (ffpcluj.call(paramInt1, paramInt2, l3 + 1L, l2 - l3 * l1, n, paramInt3 + (m << 2), paramInt5) <= 0)
/*     */             {
/*     */ 
/*     */ 
/* 256 */               n = 0;
...
/*     */ 
/*     */ 
/* 264 */               if (MainMemory.getI32(paramInt5) != 412) {
/*     */                 break label820;
/*     */               }
/*     */               
/*     */ 
...
/*     */ 
/*     */ 
/* 274 */               MainMemory.setI32(paramInt5, 0);
/* 275 */               n = 0;
/* 276 */               i2 = 1;
/*     */             }
/*     */           }
...
/* 304 */             l3 = (l2 + -1L) / l1;
/* 305 */             if (ffpclu.call(paramInt1, paramInt2, l3 + 1L, l2 - l3 * l1, i1, paramInt5) > 0) {
/*     */               break label820;
/*     */             } else {
/* 308 */               i1 = 0;
/*     */             }
...
/*     */ 
/*     */ 
/* 348 */         ffpcnuj_1363.call(paramInt5, paramLong1, l1, paramInt2, paramInt1, i1, m);
/*     */         
/*     */         break label794;
/*     */         
/*     */         label771:
/* 353 */         ffpcnuj_1364.call(paramInt3, paramInt5, paramInt2, l1, paramLong1, paramInt1, bool, m, n);
/*     */         
/*     */ 
/*     */         label794:
/*     */         
/*     */ 
/* 359 */         if ((MainMemory.getI32(paramInt5) <= 0) && (i2 != 0)) {
/*     */           break label830;
/*     */         }
/*     */       }
/*     */       
...
/*     */       
/*     */ 
/* 375 */       MainMemory.setI32(paramInt5, 412);
/*     */       
/*     */ 
/*     */       label843:
/*     */       
...
/* Location:              /home/jkim13/Desktop/emediatrack/codejar_s.jar!/com/emt/proteus/duchampopt/ffpcnuj.class
